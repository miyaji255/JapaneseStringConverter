...
namespace JapaneseStringConverter.Internal
{
    internal static class UnicodeStringConverter
    {
        ...
        internal static int ToNarrowFromEnd(ReadOnlySpan<char> source, Span<char> destination)
        {
            unsafe
            {
        ...
        /// </summary>
        /// <returns>destination の最初のインデックス</returns>
        internal static int ToWideFromEnd(ReadOnlySpan<char> source, Span<char> destination)
        {
            unsafe
            {
                var startIndex = destination.Length;
        ...
        /// </summary>
        /// <returns>destination の最初のインデックス</returns>
        internal static int ToKatakanaFromEnd(ReadOnlySpan<char> source, Span<char> destination)
        {
            unsafe
            {
                var startIndex = destination.Length;
